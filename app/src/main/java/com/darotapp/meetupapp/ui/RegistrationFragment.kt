...
class RegistrationFragment : Fragment() {
    ...
    override fun onActivityCreated(savedInstanceState: Bundle?) {
        ...
        repeatPinEditText.setOnKeyListener { view, keyCode, keyEvent ->
            if (keyEvent.action == KeyEvent.ACTION_DOWN && keyCode == KeyEvent.KEYCODE_ENTER) {
                try {
                    termsAndCondition.isChecked = true
        ...
        termsAndCondition.setOnKeyListener { view, keyCode, keyEvent ->
            if (keyEvent.action == KeyEvent.ACTION_DOWN && keyCode == KeyEvent.KEYCODE_ENTER) {
                try {
                    registerRequest()
                } catch (e: Exception) {
                ...
                CoroutineScope(Dispatchers.Main).launch {
                    ...
                    res.observeForever { t->
                        ...
                        if(!userObject?.error!!){
                            ...
                            Navigation.findNavController(registerBtn).navigate(action)
